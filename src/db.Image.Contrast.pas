...
procedure Contrast_SSEParallel_Proc(pColor: PRGBQuad; const bmpWidth: Integer; const intContrastValue: PInteger);
asm
...
begin
  ...
  TParallel.For(0, bmp.Height - 1,
    ...
    begin
      pColor := PRGBQuad(StartScanLine + Y * bmpWidthBytes);
      Contrast_SSEParallel_Proc(pColor, bmp.Width, @intContrastValue);
    end);
end;
